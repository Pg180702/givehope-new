	...
	const ctaDetails = [
		{
			...
			subheading: "Support Our Cause:",
			heading: "Donate Money to Make a Real Difference Today!",
			btnText: "Donate Money",
			ctaLink: "/donate",
		},
		{
			key: "request-blood",
			ctaClass: "second-cta-col",
			subheading: "Your Generosity Can Change Lives:",
			heading: "Become Volunteer and Help the Childs!",
