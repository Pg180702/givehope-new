...
const navigation = [
	{ name: "Home", href: "/" },
	{ name: "Donate Money", href: "/donate" },
	{ name: "Contact", href: "/contact" },
	{ name: "Events", href: "/donate-blood" },
	{ name: "Become Volunteer", href:"/contact"},
	{ name: "Donation Form", href:"/donationform"},


	{ name: "About", href: "/need-blood" }
...
const HeaderComponent = () => {
	...
	return (
		<header
			...
			className={`fixed inset-x-0 top-0 z-50 border-b bg-dark	 border-white/[.2] ${
		...
		>
			...
			>
				...
				<div className="flex lg:flex-1">
					<a href="/" className="-m-1.5 p-1.5">
						...
						<img className="w-auto h-14" src={WhiteLogo} alt="" />
					</a>
				</div>
				...
				<div className="hidden lg:flex lg:gap-x-4 lg:transition">
					{navigation.map((item) => (
						<NavLink
							...
							to={item.href}
							active="bg-red"
							className={`text-lg bg-dark text-white font-bold  hover:bg-red lg:transition leading-6  px-3 py-2  rounded-rsm ${
								item.secondLast &&
			...
			>
				...
				<Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full px-6 py-6 overflow-y-auto text-white bg-dark sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
