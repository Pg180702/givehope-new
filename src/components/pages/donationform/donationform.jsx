...
const Donationform = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_kh7sltr', 'template_40395ri', form.current, {
        ...
        <form ref={form} onSubmit={sendEmail} className="max-w-lg mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input type="text" placeholder="Last Name" name="user_email" required className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              <label className="block text-gray-700 font-bold mb-2" htmlFor="user_amount">Donation Amount (Example: 500rs, 1000rs)</label>
              <textarea name="user_amount" placeholder="Donation Amount" rows="4" className="resize-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 font-bold mb-2"required  htmlFor="user_cause">Donation Cause (Example: School Stationary Distribution
, Child Development
)</label>
              <input type="text" placeholder="Donation cause" name="user_cause" required className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 font-bold mb-2" htmlFor="user_transaction">Donation Transaction Id</label>
              <input type="text" placeholder="Donation Transaction Id" name="user_transaction" required className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
            </div>
            <div className="mb-4">
  <label className="block text-gray-700 font-bold mb-2" htmlFor="user_date">Date</label>
  <input type="date" placeholder="Date" name="user_date" required className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
</div>

            <div className="mb-4">
              <label className="block text-gray-700 font-bold mb-2" htmlFor="Message">Message for Givehope Foundation</label>
